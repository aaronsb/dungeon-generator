...
def main():
    ...
    print("  • generate_temple_images.py (for local Stable Diffusion)")
    print("  • DALL-E 3, Midjourney, Leonardo AI, etc.")
    print("\nFor best results, use the negative prompts to avoid modern elements!")
